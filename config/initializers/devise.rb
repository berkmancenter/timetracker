...
Devise.setup do |config|
  ...
  # config.secret_key = '1022fe298ee9879d3529d2c226787d6e3e0546a73a06958b38b223658472560e54c511c1ac8b8082c91545211e32b19f2d3cf28262821528725853d6ca643be1'
  ...
  config.mailer_sender = ENV['DEFAULT_SENDER'] || 'no-reply@example.com'
  ...
  # config.pepper = '1fbfb9c629a9dd4a328ebdf20d37b5daeb706c00617757728ea1b1da5eb337076784896b3c4996bc4886fe5cf2d5d007b9cbd95726b6e2c5bdf01309b9645f55'
  ...
  if Rails.application.config.devise_auth_type == 'saml'
    ...
    config.saml_attribute_map_resolver = 'Timetracker::SamlAttributeMapResolver'
    ...
    config.saml_sign_out_success_url = ENV.fetch('DEVISE_SAML_SIGN_OUT_SUCCESS_URL', Rails.application.config.front_url)
    ...
    config.saml_configure do |settings|
      ...
      settings.idp_sso_service_url = ENV['DEVISE_SAML_IDP_SSO_SERVICE_URL'] if ENV['DEVISE_SAML_IDP_SSO_SERVICE_URL'].present?
      settings.idp_slo_service_url = ENV['DEVISE_SAML_IDP_SLO_SERVICE_URL'] if ENV['DEVISE_SAML_IDP_SLO_SERVICE_URL'].present?
